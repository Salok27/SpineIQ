...
**Version:** 2.0 — D2C Self-Assessment Specification  
**Prepared by:** Business Analysis & Product Management  
**Source Documents:** Stakeholder direction (2026-06-08), Daily Habit Snapshot (Dr. Ayush Sharma / SSS), Spine Severity Assessment System (SSS), Open Questions Resolution Log (OQ-01 through OQ-21)  
**Status:** Confirmed — Product direction updated from Clinic Mode to Direct-to-Consumer
...
### Screen 1 — Home / Personal Dashboard
- Personalised welcome ("Hello, [name]")
- **Start New Assessment** — primary CTA button
- **Last Assessment Summary Card** — shown after first completed assessment: score badge, severity tier, date, "View Report" link
- **My Progress shortcut** — shown after 2+ completed assessments
- **Reminder badge** — shown if a configured reassessment reminder is overdue
- Settings access (top-right)
...
- "Delete all my data" cascades to delete the user profile and all associated assessments and scores
...
| FE-14 | Goal setting — user sets lifestyle improvement targets and tracks progress toward them | Phase 2 |
| FE-15 | Achievement system — milestone badges for improvement streaks | Phase 3 |
